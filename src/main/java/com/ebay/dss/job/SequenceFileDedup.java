 ...
 * Date: 2014/7/7.
 */
public class SequenceFileDedup extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        int ret = ToolRunner.run(new SequenceFileDedup(), args);
        System.exit(ret);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        try {
            ...
            job.setJarByClass(SequenceFileDedup.class);
